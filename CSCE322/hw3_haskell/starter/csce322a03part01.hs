...
-- onePlayerOneSlide maze move -> result of sliding the player
onePlayerOneSlide maze move = onePlayerOneSlideHelper maze move player
  where
    player = '1'

onePlayerOneSlideHelper :: [[Char]] -> Char -> Char -> [[Char]]
onePlayerOneSlideHelper [[]] _ _ = [[]]
